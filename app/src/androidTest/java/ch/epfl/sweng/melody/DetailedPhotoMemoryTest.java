...
public class DetailedPhotoMemoryTest extends MenuActivityTest {
...
//        nView(withId(R.id.memoryAuthorPic)).check(matches(allOf(isEnabled(), isClickable()))).perform(click());
//        Thread.sleep(100);
